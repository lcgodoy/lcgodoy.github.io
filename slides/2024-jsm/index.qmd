...
subtitle: |
  Available at [lcgodoy.me/slides/2024-jsm/](https://lcgodoy.me/slides/2024-jsm/)
author:
...
- [Joint density]{.important2}: $p(\mathbf{y} \mid \mathbf{z}, \boldsymbol{\theta}) =
  \prod_{i = 1}^n f(y(\mathbf{s}_i) \mid \mu_i, \omega)$
...
- [Posterior]{.important2}: $\pi(\boldsymbol{\theta} \mid \mathbf{y}, \mathbf{z}) \propto
...
- [Goodness-of-fit criteria]{.important2}: WAIC, and LOOIC ([lower values
