...
## Demographic processes {auto-animate=true}
...
## Process and Observation error {auto-animate=true}
...
![](img/logo.png){.absolute bottom=10 right=85 width="200" height="200"}

![](img/finrisk.png){.absolute top=10 left=85 width="200" height="100"}
