...
subtitle: |
  Available at [lcgodoy.me/slides/2024-ucsc/](https://lcgodoy.me/slides/2024-ucsc/)
author:
...
* Point-referenced data
    ...
    * _Gaussian processes (GP)_; _Nearest-neighbor mixture processes (NNMP)_
...
- The induced [covariance function]{.important2} is given by $\mathrm{Cov}(Z(\mathbf{s}_1),
...
- Useful special cases:
    ...
    - [Homoscedastic]{.important2}: $w(\mathbf{s}) = 0 \implies \exp \{ \alpha_0
      \} = \sigma$
...
- Unfortunately, functions that are [guaranteed]{.important} to be
  [positive-definite]{.important} on [$(\lVert \cdot \rVert_2,
  \mathbb{R}^2)$]{.important} are [not]{.important} necessarily positive
  definite on [other metric spaces]{.important} [@li2023inference].
:::
...
- The theorem above [guarantees the validity]{.important} of the
